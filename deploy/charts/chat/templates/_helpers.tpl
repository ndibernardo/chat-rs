...
Standard labels for a workload. Call as:
  include "chat.labels" (dict "root" $ "workload" "user-service")
*/}}
{{- define "chat.labels" -}}
...
field is immutable once created). Call as chat.labels above.
*/}}
...
as: include "chat.topologySpreadConstraints" (dict "root" $ "workload" "user-service")
*/}}
{{- define "chat.topologySpreadConstraints" -}}
...
root context: include "chat.commonEnv" .
*/}}
{{- define "chat.commonEnv" -}}
- name: RUN_MODE
  value: kubernetes
- name: LOG_FORMAT
  value: json
...
context: include "chat.userCoreEnv" .
*/}}
{{- define "chat.userCoreEnv" -}}
- name: DATABASE__URL
  valueFrom:
    secretKeyRef:
      name: user-db-app
...
apart. Call with the root context: include "chat.chatCoreEnv" .
*/}}
{{- define "chat.chatCoreEnv" -}}
- name: DATABASE__URL
  valueFrom:
    secretKeyRef:
      name: chat-db-app
