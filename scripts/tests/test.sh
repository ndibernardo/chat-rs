...
DATABASE_URL="postgresql://postgres:postgres@localhost:5433/user" sqlx migrate run --source services/user-service/migrations
DATABASE_URL="postgresql://postgres:postgres@localhost:5433/chat" sqlx migrate run --source services/chat-service/migrations
